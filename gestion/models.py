...
class ProductoModel(models.Model):
    ...
    descripcion = models.CharField(max_length=80, unique=True, null=False)
    ...
    categoria = models.ForeignKey(to=CategoriaModel, on_delete=models.PROTECT, db_column='categoria_id', related_name='productos')
...
class DetallesOrdenModel(models.Model):
    ...
    producto_id = models.ForeignKey(ProductoModel, on_delete=models.CASCADE)
